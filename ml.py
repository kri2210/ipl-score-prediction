...
st.set_page_config(page_title="🏏 IPL Score Predictor (Over Level)", layout="centered")

st.title("🏏 IPL Score Prediction (Over-Level Model)")
...
overs = st.number_input("Overs Completed", min_value=0, max_value=19, value=1)
